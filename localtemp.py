...
#     t = tf.constant([1,2,3,4,5,6,7,8], shape=[2, 4])
#     g = tf.constant([2,4,6,8,10,12], shape=[3,2])
#
#     print(sess.run(t))
#     print(sess.run(g))
#
#     t = tf.reshape(tf.tile(t, [1, 3]), [6,4])
#     g = tf.tile(g, [2, 1])
#     print(sess.run(t))
#     print(sess.run(g))
#
#     p = tf.reshape(tf.concat([t,g], 1), [2,3,6])
#     print(sess.run(p))
#
#     a = tf.reshape(p[0], [6,-1])
#     print(sess.run(a))
